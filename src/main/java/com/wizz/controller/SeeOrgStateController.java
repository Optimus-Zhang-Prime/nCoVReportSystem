...
public class SeeOrgStateController {//按组织查看疫情信息
    ...
    public JSONObject seeOrgState(@RequestParam("orggrade")Integer orggrade,@RequestParam("orgid") Integer orgid) throws JSONException {
    ...
    public JSONObject seeAllUser(@RequestParam("orggrade")Integer orggrade,@RequestParam("orgid") Integer orgid) throws JSONException {
