...
//        jsonObject.put("allUsers", allUsers);
    ...
    public String seeOrgByParentClass(@RequestParam("orggrade")Integer orggrade,@RequestParam("orgfathername") String orgfathername,@RequestParam("orgname")String orgname){
        List<Org> org =seeStateService.getorgByParentClass(orggrade,orgfathername,orgid);
        String result = JSON.toJSONString(org);
        return result;
    }
}
